...
/* VOID:UINT,UINT (c:\temporary\libnotify\libnotify\libnotify\notify-marshal.list:1) */
...
/* VOID:UINT,STRING (c:\temporary\libnotify\libnotify\libnotify\notify-marshal.list:2) */
